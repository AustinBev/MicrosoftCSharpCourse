                ...
                switch (menuSelection)
                {
                    ...
                    case "3":
                        ...
                        for (int i = 0; i < maxPets; i++)
                        {
                            ...
                            {
                                Console.WriteLine("Please enter a valid physical description for your furry friend.");
                                readResult = Console.ReadLine();
                                if (readResult != null)
                                {
                        ...
                        Console.WriteLine($"The animals age is {animalAge}, and their physcial description is {animalPhysicalDescription}.");
                        Console.WriteLine("Press the Enter key to continue.");
                        readResult = Console.ReadLine();
                        break;
